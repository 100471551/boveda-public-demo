# Third-party material and publication prerequisites

This inventory records attribution and unresolved permissions. It does not grant a license or assert that all third-party material has been cleared for redistribution.
...
| Bóveda source and documentation | This repository | No general open-source license has been selected by the owner. Do not infer an MIT, Apache or other license grant. |

Flink's product and license options are described by the [publisher listing](https://www.myfonts.com/collections/flink-font-moritz-kleinsorge). The actual purchased license, if any, is the relevant evidence for the owner's permitted uses.

Removing a restricted file from the current tree would not remove its earlier versions from Git history, tags, forks or prior downloads. Any future removal or history rewrite requires a separate, deliberate publication plan. Font substitution is not part of the current review.
